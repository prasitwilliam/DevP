      ...
      >
          ...
          {available ? (
            <>
              ...
              <Link
                ...
                className=" w-[65px] rounded-full bg-white p-5  text-[20px] md:text-[24px] lg:text-[28px]"
                data-blobity
                data-blobity-radius="35"
                data-blobity-offset-x="4"
                data-blobity-offset-y="4"
        ...
        <div
          className={`absolute text-white  ${
            !(id % 2 === 0)
              ? "right-0 top-32 ml-10 mr-0 md:right-0 md:ml-0 lg:right-0 lg:top-40  lg:mr-4"
            ...
            {technologies.map((IconComponent, id) => (
              <div key={id} className={"relative"}>
                <Link
                  ...
                  className="w-[30px]  text-[20px] md:text-[24px] lg:text-[28px]"
                  title={techLinks[id]}
